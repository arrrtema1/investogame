import { Sector, Bond, RealEstate } from '../types/game.types';
...
export const INITIAL_REAL_ESTATE: RealEstate[] = [
    { id: 801, name: 'Small Flat', price: 1250, income: 15, type: 'realestate' },
    { id: 802, name: 'Big Flat', price: 2500, income: 15, type: 'realestate' },
    { id: 803, name: 'Shop', price: 4000, income: 20, type: 'realestate' },
    { id: 804, name: 'House', price: 6000, income: 25, type: 'realestate' },
    { id: 805, name: 'Warehouse', price: 7500, income: 30, type: 'realestate' },
    { id: 806, name: 'Building', price: 10000, income: 35, type: 'realestate' }
];
...
export const INITIAL_BONDS: Bond[] = [
    ...
    { id: 903, name: 'Construction Co.', price: 2000, income: 10, type: 'bond' }
];
